...
Cette protection empêche le fichier d’être inclus plusieurs fois lors de la compilation,
ce qui évite les erreurs de redéfinition.
...
Cette inclusion permet l’accès à toutes les fonctions de la bibliothèque HAL de STM32 :
...
Cette fonction est appelée en cas d’erreur critique (initialisation de l’horloge,
mauvaise configuration d’un périphérique, etc.).
...
L’utilisation de constantes rend le code plus lisible et plus facile à modifier
en cas de changement de câblage.
...
Ce fichier constitue la base de l’architecture logicielle de la mini-serre intelligente.
